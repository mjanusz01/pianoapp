...
val testPieceB3 = Beat(
    notes =  listOf(
        ...
        Note(NotePitch.GIS3, 0F, NoteDuration.QUARTER_NOTE),
        Note(NotePitch.GIS4, 0F, NoteDuration.QUARTER_NOTE),
        Note(NotePitch.A2, 1F, NoteDuration.QUARTER_NOTE),
        Note(NotePitch.A3, 1F, NoteDuration.QUARTER_NOTE),
        Note(NotePitch.A4, 1F, NoteDuration.QUARTER_NOTE),
        Note(NotePitch.B2, 2F, NoteDuration.QUARTER_NOTE),
        Note(NotePitch.B3, 2F, NoteDuration.QUARTER_NOTE),
        Note(NotePitch.B4, 2F, NoteDuration.QUARTER_NOTE),
        Note(NotePitch.H2, 3F, NoteDuration.QUARTER_NOTE),
        Note(NotePitch.H3, 3F, NoteDuration.QUARTER_NOTE),
        Note(NotePitch.H4, 3F, NoteDuration.QUARTER_NOTE),
    ),
    measure = Measure.MEASURE_FOUR_QUARTER,
    key = Key.VIOLIN_KEY,
)
